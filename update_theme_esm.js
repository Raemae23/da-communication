...
const replacements = [
  ...
  { search: /bg-slate-50\/30/g, replace: "bg-[#F8F9FA]/30" },
  ...
  { search: /focus:ring-da-green-[6]00\/[51][0]?/g, replace: "focus:ring-[#1E5631]/10" },
  { search: /focus-within:ring-da-green-[6]00\/[15][0]?/g, replace: "focus-within:ring-[#1E5631]/10" },
  
  { search: /shadow-green-[9]00\/[23]0/g, replace: "shadow-[#1E5631]/20" },
  ...
  { search: /group-hover\/sig:bg-da-green-[6]00\/[15][0]?/g, replace: "group-hover/sig:bg-[#1E5631]/10" },
